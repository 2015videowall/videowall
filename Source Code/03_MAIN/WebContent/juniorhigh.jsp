...
%><%
String filename = "juniorhigh.jsp";
...
String TAG = "微電影@EduCase創意競賽-國中組";
WebStorageUser wsu;
...
respf = fb.getResponse(wsu.getUserID(), wsu.getInfoRelay(), wsu.getCurrentToken(), folderIDJuniorhigh, "VIDEO", sortby, sortdirection);
List<PublicFileBase> juniorhighVideoList = respf.getFiles();


if("vote".equals(sort)){
	//處理投票排序
	Collections.sort(juniorhighVideoList);
}
...
<div id="bgpic">
    ...
    <div class="container">
        ...
        <div class="content">
	            <div class="light"></div>
				<div class="juniorhighall"><a name="start">&nbsp;</a>
				    <h1>國中組</h1>
				    <div class="linkarea" id="linkarea">
		            	...
		            	<select name="link" id="link">
		            		...
		            		<option value="juniorhigh.jsp#start" selected>國中組</option>
