...
%><%
String filename = "seniorhigh.jsp";
...
String TAG = "微電影@EduCase創意競賽-高中組";
WebStorageUser wsu;
...
respf = fb.getResponse(wsu.getUserID(), wsu.getInfoRelay(), wsu.getCurrentToken(), folderIDSeniorhigh, "VIDEO", sortby, sortdirection);
List<PublicFileBase> seniorhighVideoList = respf.getFiles();


if("vote".equals(sort)){
	//處理投票排序
	Collections.sort(seniorhighVideoList);
}
				...
				<div class="seniorhighall"><a name="start">&nbsp;</a>
					...
					<div class="linkarea" id="linkarea">
		            	...
		            	<select name="link" id="link">
		            		...
		            		<option value="seniorhigh.jsp#start" selected>高中組</option>
