...
String TAG = "微電影@EduCase創意競賽-高職組";
WebStorageUser wsu;
...
respf = fb.getResponse(wsu.getUserID(), wsu.getInfoRelay(), wsu.getCurrentToken(), folderIDVoctional, "VIDEO", sortby, sortdirection);
List<PublicFileBase> voctionalVideoList = respf.getFiles();

if("vote".equals(sort)){
	//處理投票排序
	Collections.sort(voctionalVideoList);
}
...
<div id="bgpic">
    ...
    <div class="container">
        ...
        <div class="content">
	            <div class="light"></div>
				<div class="vocationalall"><a name="start">&nbsp;</a>
						<h1>高職組</h1>
		            	...
		            	<select name="link" id="link">
		            		...
		            		<option value="voctional.jsp#start" selected>高職組</option>
