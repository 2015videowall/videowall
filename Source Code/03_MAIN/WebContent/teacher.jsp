...
String TAG = "微電影@EduCase創意競賽-教職員組";
WebStorageUser wsu;
...
respf = fb.getResponse(wsu.getUserID(), wsu.getInfoRelay(), wsu.getCurrentToken(), folderIDTeacher, "VIDEO", sortby, sortdirection);
List<PublicFileBase> teacherVideoList = respf.getFiles();

if("vote".equals(sort)){
	//處理投票排序
	Collections.sort(teacherVideoList);
}
...
<div id="bgpic">
    ...
    <div class="container">
        ...
        <div class="content">
	            <div class="light"></div>
				<div class="teacherall"><a name="start">&nbsp;</a>
					<h1>教職員組</h1>
					<div class="linkarea" id="linkarea">
		            	...
		            	<select name="link" id="link">
		            		...
		            		<option value="teacher.jsp#start" selected>教職員組</option>
		            	</select>
	            		</div>
