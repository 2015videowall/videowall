...
{	
	...
	public EarnTokenResponse getResponse(String userid, String server) throws Exception
	{		
		...
		String[] elmName = { "userid" };// Define each XML tag name
		String[] data = { userid };// Set each value of tag
		...
		{
			throw new Exception("Error : You have to check EarnToken api response, status=(" + rsp.getStatus() + ") ||  rsp= " + rsp.toString());
		}
